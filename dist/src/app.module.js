...
const user_service_1 = require("./infrastructure/services/user/user.service");
const user_service_module_1 = require("./infrastructure/services/user/user.service.module");
...
AppModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [jwt_strategy_1.JwtStrategy, app_service_1.AppService, user_service_1.UserService, auth_service_1.LoginService],
    })
], AppModule);
